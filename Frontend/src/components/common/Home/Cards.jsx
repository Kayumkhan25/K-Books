            ...
            <div className="card bg-base-10 w-80 lg:w-[350px] h-[450px] lg:h-[480px] mx-auto shadow-sm bg-slate-100 border-t-[1px] border-green-900 shadow-green-300 my-2 hover:scale-105 duration-300 hover:shadow-md hover:shadow-slate-400
                ...
                <div className="card-body">
                    ...
                    <div className="card-actions justify-between w-11/12 mx-auto">
                        ...
                        <div className=" border-2 border-green-700 bg-green-600 rounded-full cursor-pointer text-white px-3 py-[2px] hover:bg-green-700 hover:font-[500] hover:border-green-500 transition-all duration-300">Buy Now</div>
                    </div>
                </div>
            </div>
        </div>
